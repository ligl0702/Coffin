<article class="sandraItem">
    <div class="sandraItem-inner">
        <div class="sandraItem-image"><a style="background-image: url(<?php echo coffin_get_background_image($post->ID,400,280);?>);" href="<?php the_permalink();?>" title="<?php the_title();?>"></a></div>
